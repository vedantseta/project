...
//TesTing 
				...
				if(element[2].equals(team))				
				{
					...
					if(stats[0].equals("-"))
					p1=0;
					else if(Double.parseDouble(stats[0])>=100 )
					p1=1;
					else
					...
					if(stats[1].equals("-"))
					p1=0;
					else if(stats[1].equals("-"))
					p2=0;
					else if(Double.parseDouble(stats[1])>=10000)
					p2=1;
					else
					...
					String data = tempstr;
 					String filename="C:\\Users\\Vedant\\Desktop\\project_v0.6\\project_v0.6"+team+".txt";
